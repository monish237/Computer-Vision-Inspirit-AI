...
!wget - O / content / data / image.jpg
"https://storage.googleapis.com/inspirit-ai-data-bucket-1/Data/AI%20Scholars/Sessions%206%20-%2010%20(Projects)/Project%20-%20%20Object%20Detection%20(Autonomous%20Vehicles)/image.jpg"
...
!wget - O / content / data / image2.jpg
"https://storage.googleapis.com/inspirit-ai-data-bucket-1/Data/AI%20Scholars/Sessions%206%20-%2010%20(Projects)/Project%20-%20%20Object%20Detection%20(Autonomous%20Vehicles)/image2.jpg"
...
!wget - O / content / data / video1.mp4
"https://storage.googleapis.com/inspirit-ai-data-bucket-1/Data/AI%20Scholars/Sessions%206%20-%2010%20(Projects)/Project%20-%20%20Object%20Detection%20(Autonomous%20Vehicles)/6.mp4"
...
!wget - O / content / data / yolo_weights.h5
"https://storage.googleapis.com/inspirit-ai-data-bucket-1/Data/AI%20Scholars/Sessions%206%20-%2010%20(Projects)/Project%20-%20%20Object%20Detection%20(Autonomous%20Vehicles)/yolo.h5"
...
image_detect_nms = draw_boxes(image_pil, nms_boxes, labels)
image_detect = draw_boxes(image_pil, boxes, labels)
plt.figure()
plt.imshow(image_detect)
plt.show()
plt.figure()
plt.imshow(image_detect_nms)
plt.show()
...
def detect_video(video_path, output_path, obj_thresh=0.4, nms_thresh=0.45, darknet=darknet, net_h=416, net_w=416,
    ...
    while vid.isOpened():
        ...
        if ret:
            ### YOUR CODE HERE
            new_frame = frame
            PIL_frame = Image.fromarray(cv2.cvtColor(new_frame, cv2.COLOR_BGR2RGB))
            detect_frame = detect_image(PIL_frame, obj_thresh=0.4, nms_thresh=0.45, darknet=darknet, net_h=416,
                                        net_w=416, anchors=anchors, labels=labels)
            output_frame = cv2.cvtColor(np.asarray(detect_frame), cv2.COLOR_RGB2BGR)
            ### END CODE
...
output_path = '/content/data/video1_detected_new.mp4'
